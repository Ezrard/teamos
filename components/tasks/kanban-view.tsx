...
import { AlertTriangle, Calendar, Clock, GripVertical, Pencil } from "lucide-react";
...
function DraggableTaskCard({
  ...
  return (
    ...
    >
      <TaskCard task={task} dragListeners={listeners} dragAttributes={attributes} projects={projects} onTaskEdit={onTaskEdit} />
    </div>
  );
}
...
export function KanbanView({
  ...
  return (
    ...
    >
      ...
      <DragOverlay>
        {activeTask && (
          <TaskCard task={activeTask} isOverlay projects={projects} />
        )}
      </DragOverlay>
    </DndContext>
  );
